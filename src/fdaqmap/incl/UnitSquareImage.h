...
void multfact_image(double *multfact, const double *dfdu, const double *dfdv,
                    int n, int t, int d);
void surface_to_q(double *q, const double *f, const double *multfact, int n,
                  int t, int d);
void Calculate_Distance(double *H, const double *q1, const double *q2, int n,
                        int t, int d);
void findphistar(double *w, double *q, double *b, int n, int t, int d, int K);
void findupdategam(double *gamupdate, const double *v, const double *w,
                   const double *b, int n, int t, int d, int K);
void updategam(double *gamnew, const double *gamupdate, const double *gamid,
               double eps, int n, int t, int D);
void Apply_gam_gamid(double *gamcum, const double *gamid, const double *gaminc,
                     int m, int n);
