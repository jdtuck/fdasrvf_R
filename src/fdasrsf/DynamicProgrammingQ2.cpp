...
int DynamicProgrammingQ2(double *Q1, double *T1, double *Q2, double *T2, const int *m1,
  ...
  dp_nbhd = dp_generate_nbhd(*nbhd_dim1, &nbhd_count);
  ...
  else
  {
    ...
    dp_costs( Q1, T1, *n1, Q2, T2, *n2,
      *m1, tv1, idxv1, *n1v, tv2, idxv2, *n2v, E, P, *lam1, *pen1,
      nbhd_count, dp_nbhd);
